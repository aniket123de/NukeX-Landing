    ...
    <section className="py-20 md:py-28">
      <div className="container">
        ...
        <p className="text-white/70 text-lg md:text-xl text-center tracking-tight mt-5 max-w-3xl mx-auto">
          Cross-platform tool for Windows, Linux, and Android with blockchain-based 
          tamper-proof certificates. One-click erasure with NIST SP 800-88 compliance 
          and offline mode for legacy devices.
        </p>
